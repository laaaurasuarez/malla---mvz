const ramos = [
  ...
  { nombre: "Enfermedades infecciosas", id: "infecciosas", requiere: ["fisiologia", "anatomia", "parasitologia", "patologia_general", "microbiologia", "inmunologia"], desbloquea: ["medicina_preventiva", "farmacologia", "patologia_clinica", "reproduccion"], semestre: "sem5", orden: 1 },
  ...
  { nombre: "Medicina veterinaria preventiva y epidemiológica", id: "medicina_preventiva", requiere: ["infecciosas"], desbloquea: ["salud_publica", "medicina_interna"], semestre: "sem6", orden: 1 },
  ...
  { nombre: "Sistema de producción", id: "sistema_produccion", semestre: "sem6", orden: 6 },
  ...
  { nombre: "Salud pública veterinaria", id: "salud_publica", requiere: ["medicina_preventiva"], semestre: "sem7", orden: 3 },
  { nombre: "Medicina interna", id: "medicina_interna", requiere: ["semiologia", "farmacologia", "medicina_preventiva"], semestre: "sem7", orden: 4 },
  { nombre: "Toxicología médica y de la producción", id: "toxicologia", requiere: ["farmacologia"], semestre: "sem7", orden: 5 },
  { nombre: "Administración y gerencia de empresas pecuarias", id: "administracion", semestre: "sem7", orden: 6 },

  // CUARTO AÑO – SEMESTRE VIII
  { nombre: "Formulación y evaluación de proyectos", id: "formulacion", semestre: "sem8", orden: 1 },
  { nombre: "Clínica de grandes animales", id: "clinica_grandes", semestre: "sem8", orden: 2 },
  { nombre: "Clínica de pequeños animales", id: "clinica_pequenos", semestre: "sem8", orden: 3 },
  ...
  { nombre: "Tecnología de alimentos", id: "tecnologia_alimentos", semestre: "sem9", orden: 6 },
  ...
  { nombre: "Opción de grado", id: "opcion_grado", semestre: "sem10", orden: 2 },
];
